...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50">
      {/* Cover Background */}
      <div className="relative h-80 bg-gradient-to-r from-primary via-indigo-600 to-purple-600 overflow-hidden">
              ...
              {!editing && (
                <div className="flex flex-col gap-2">
                  <button
                    ...
                    className="px-6 py-3 bg-primary text-white rounded-xl hover:bg-primary-dark transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center gap-2"
                  >
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
